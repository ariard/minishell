...
t_btree				*ft_ast_insert_sequence(t_root *tree,
					t_btree *father, t_dlist *operand, t_dlist *operator);
...
int					ft_execute_all_dir(t_btree *node, t_btree *father,
					t_info *info, t_root *tree);

int					ft_execute_operand(t_btree *node, t_btree *father,
					t_info *info, t_root *tree);
...
void				ft_complete_bin(char *buffer,
					t_dlist **list_bin, t_screen *screen);
...
void				ft_complete_path(char *buffer, char *path,
					t_screen *screen);
...
char				*ft_set_new_path(char *buffer, char *path,
					t_dlist **list);
...
void				ft_return_buffquote(char *buffer, char *buffquote,
					int n);
